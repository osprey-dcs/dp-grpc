...
> exposure at step 5; it starts at step 4. The fix is part of the preparation PR,
> [osprey-dcs/dp-python-lib#60](https://github.com/osprey-dcs/dp-python-lib/pull/60) (open, not yet
> merged, when this note was written), and that PR was verified against locally generated
> mypy-protobuf stubs with the checker included. Any later check against those stubs, including
> step 3's, should run the checker as well as `mypy src/`.
